const universeConfig = [
  ...
  { id: 'dc', slug: 'dc', name: 'DC', shortName: 'DC', type: 'shared-universe', description: 'DC screen universes and stories.', featured: true, tmdbCollectionIds: [], tmdbCompanyIds: [9993], tmdbKeywordIds: [] },
